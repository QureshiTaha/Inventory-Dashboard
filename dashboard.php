            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.success) {
                        ...
                        $("#total_products").text(stats.totalProducts ? stats.totalProducts : 0);
                        $("#total_stock").text(stats.totalStock? stats.totalStock : 0);
                        $("#total_stock_value").text(stats.stockValue ? stats.stockValue : 0);
